...
if(isset($_SESSION['login']) && ($_SESSION['reportexcajero'] == 1)){
              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Reporte Cobranzas por Cajero </h1>
                    ...
                    <div class="panel-body table-responsive" id="listadoregistros">
                        <form action='../reportes/reporte_cajero.php' name="formulario" id="formulario" method="POST">
...
?>
<script type="text/javascript" src="scripts/reportePorCajero.js"></script>
