...
if($_GET){
	...
	$ldate=date('Y-m-d');
	$ldate=$row['fecha_cobranzas'];
	$ldate=substr($ldate,0,10);
	...
	$pdf->Cell(100);
	$numero = intval($id_registro);
	$pdf->Cell(25,7,'No: ' . $numero, 0, 0, 'L',0);
	...
	$pdf->Line(87.00,152.00, 121.00, 152.00, null);
