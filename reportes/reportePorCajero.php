...
if(isset($_POST['exportar'])){
	...
	$spreadsheet->getActiveSheet()
		->setCellValue('A1',"REPORTE CONSOLIDADO POR CAJERO");
	...
	// $spreadsheet->getActiveSheet()->getColumnDimension('I')->setWidth(20); MALY 27/02/2024
	...
	$spreadsheet->getActiveSheet()->getColumnDimension('O')->setWidth(15); // CI Asesor MALY 29/02/2024	
	...
	$spreadsheet->getActiveSheet()
		->setCellValue('A3','Agencia: ' . $nombre_agencia);
		$spreadsheet->getActiveSheet()->getStyle('A3')->getFont()->setSize(11)->setBold(true);


	$spreadsheet->getActiveSheet()
		->setCellValue('O2','Fecha de Inicio: ' . $f_ini);
		$spreadsheet->getActiveSheet()->getStyle('O2')->getFont()->setSize(11)->setBold(true);

	$spreadsheet->getActiveSheet()
		->setCellValue('O3','Fecha de Fin: ' . $f_fin);
		$spreadsheet->getActiveSheet()->getStyle('O3')->getFont()->setSize(11)->setBold(true);


	$spreadsheet->getActiveSheet()
		->setCellValue('O4','Fecha & Hora Impresión: ' . $fecha);
		$spreadsheet->getActiveSheet()->getStyle('O4')->getFont()->setSize(11)->setBold(true);	
	...
	$spreadsheet->getActiveSheet()
		...
		->setCellValue('G5',"Fec Ini")
		->setCellValue('H5',"Fec Cob")
		// ->setCellValue('I5',"Fec Fac") MALY 27/02/2024
		...
		->setCellValue('O5',"CI Asesor") // CI Asesor MALY 29/02/2024
		->setCellValue('P5',"Vendedor")
		->setCellValue('Q5',"Estado");

	//set font style and background color
	$spreadsheet->getActiveSheet()->getStyle('A5:Q5')->applyFromArray($tableHead);
	...
	while ($student = mysqli_fetch_assoc($rows)){
		...
		$spreadsheet->getActiveSheet()
			...
			// ->setCellValue('I'.$row , $student['fechaFacturacion']) MALY 27/02/2024
			...
			->setCellValue('O'.$row , $student['cedula_asesor']) // CI Asesor MALY 29/02/2024
			->setCellValue('P'.$row , $student['usuario'])
...
function getData($db, $f_ini, $f_fin, $codigo_agencia,$id_usuario){
	...
	$sql = "SELECT t.id, a.codigo_agencia, a.nombre_agencia as agencia, k.nombre_ciudad as ciudad,
				...
				AND DATE(t.fecha_cobranzas) >= '$f_ini' AND DATE(t.fecha_cobranzas) <= '$f_fin'
